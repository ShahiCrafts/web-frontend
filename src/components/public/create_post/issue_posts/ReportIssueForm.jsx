// components/issue_posts/ReportIssueForm.jsx
import {
  AlertTriangle,
  MapPin,
  Phone,
...
import { useRef, useState } from 'react'; // Removed useState for files, as it will come from props
...
// Add attachments and setAttachments to props
export default function ReportIssueForm({ report, setReport, attachments, setAttachments }) {
  const {
    visibility,
    issueTitle,
    issueDescription,
  ...
  // Removed: const [files, setFiles] = useState([]); // Now controlled by attachments prop
    ...
    <form className="space-y-6 text-gray-800">
      ...
      <FormSection icon={Tag} title="Issue Classification">
        ...
        <FormSelect
          ...
          value={priorityLevel}
          onChange={(e) => updateReportField('priorityLevel', e.target.value)}
          required
        >
        ...
        <FormSelect
          ...
          onChange={(e) => updateReportField('responsibleDepartment', e.target.value)}
          required
        >
      ...
      <FormSection icon={MapPin} title="Location">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            This sets the address field to the current coordinates
          </p>
        </div>
      </FormSection>
      ...
      <FormSection icon={UploadCloud} title="Evidence & Photos">
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-4 rounded-md">
          <div className="flex">
            ...
            <div className="ml-3 text-sm text-blue-700">
              <p>
                <span className="font-semibold">Photo Tips:</span> Take clear photos showing the issue from multiple angles.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {/* Render files from attachments prop */}
